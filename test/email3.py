...
#构造附件1
att1 = MIMEText(open('D:\\2018-01-29-所有PL问卷完成情况.xls', 'rb').read(), 'base64', 'gb2312')
...
msg['from'] = 'notify@sophiroth.com'
msg['subject'] = 'hello world'
#发送邮件
try:
    server = smtplib.SMTP()
    server.connect('smtp.exmail.qq.com')
    server.login('notify@sophiroth.com','Notify+2018')#XXX为用户名，XXXXX为密码
